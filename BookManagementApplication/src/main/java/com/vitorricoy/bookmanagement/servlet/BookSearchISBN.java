...
/**
 * Book search by isbn servlet
 * @author vitor
 */
@WebServlet(name = "BookSearchISBN", urlPatterns = {"/BookSearchISBN"})
public class BookSearchISBN extends HttpServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
        ...
        try{
            ...
            String isbn = gson.fromJson(json, String.class);
